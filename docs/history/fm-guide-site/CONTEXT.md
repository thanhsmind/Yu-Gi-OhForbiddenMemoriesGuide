...
| D12 | **Ảnh thứ hai** (art Rush Duel) nén sang WebP bề rộng ~400px, ngân sách cả thư mục dưới 40MB; ảnh gốc PNG 350MB không vào repo. Trong popup chi tiết, **bấm thẳng vào ảnh** để đảo qua lại, có chỉ báo nhỏ. Lá không có ảnh thứ hai thì không đảo được và không hiện chỉ báo. ~~Ảnh in-game là mặc định~~ — **mệnh đề mặt mặc định bị D13 thay** | Thư mục ảnh hiện tại chỉ 31MB — giữ nguyên gốc sẽ phình repo hơn 10 lần |
| D13 | **Thay mệnh đề mặt mặc định của D12.** Ảnh Rush Duel là mặt mặc định của popup chi tiết; bấm để đảo về ảnh in-game. 26 lá Ritual không có ảnh Rush Duel vẫn mở bằng ảnh in-game và không đảo được. Ô giữ chỗ vẫn ghi đường dẫn ảnh in-game, vì đó mới là mặt có thể thiếu | Người dùng xem trên trang thật rồi quyết định: ảnh Rush Duel nét hơn hẳn ảnh chụp màn hình game. Thêm nữa 360 lá ngoài FM không có ảnh in-game, nên mở bằng mặt in-game cho cả nhóm đó một ô giữ chỗ thay vì một tấm ảnh |
